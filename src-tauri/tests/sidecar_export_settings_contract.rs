...
fn scheduled_export_sync_sends_payload_settings_and_persists_runs() {
    ...
    upsert_setting(
        ...
        UpsertSetting {
            ...
            value: SettingValue::Object(json!({
                ...
                "csvEnabled": true,
                "csvOutputPath": "/tmp/job-hunt-applications.csv",
            ...
            "result": {
                ...
                "runs": [
                    ...
                    },
                    {
                        ...
                        "status": "completed",
                        "recordsWritten": 2,
                        "externalUrl": "file:///tmp/job-hunt-applications.csv",
                        "syncedAt": "2026-05-29T06:00:00.000Z"
                    },
                    {
                        "exporterId": "airtable",
    ...
    assert_eq!(
        ...
        json!({
            "enabled": true,
            "outputPath": "/tmp/job-hunt-applications.csv"
        })
    );
    assert_eq!(
