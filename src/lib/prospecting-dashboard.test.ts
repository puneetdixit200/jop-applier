  ...
  it("builds a selected review panel and applies review decisions", () => {
    ...
    const emails = [
      email({
        ...
        body_html: "<p>Hi Priya,</p><p>Sharing one more relevant platform project.</p><p>If this is not relevant, you can <a href=\"job-hunt://unsubscribe?token=abc\">unsubscribe</a>.</p>",
    ...
    expect(buildOutreachReviewPanel({ companies, contacts, emails, selectedEmailId: "pending-2" })).toEqual({
      ...
      contactLabel: "Priya <priya@setu.co>",
      subject: "Follow-up on API roles",
      bodyPreview: "Hi Priya, Sharing one more relevant platform project. If this is not relevant, you can unsubscribe.",
